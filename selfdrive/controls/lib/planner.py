...
_AP_CRUISE_MAX_V = [1.0, 1.0, 1.0, 0.5, 0.3]
_AP_CRUISE_MAX_V_ECO = [0.8, 0.8, 0.8, 0.4, 0.3]
_AP_CRUISE_MAX_V_SPORT = [1.2, 1.2, 1.2, .7, .5]
_AP_CRUISE_MAX_V_FOLLOWING = [1.0, 1.0, 1.0, 0.5, 0.3]
