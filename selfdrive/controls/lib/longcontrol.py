...
class LongControl():
  ...
  def update(self, active, v_ego, gas_pressed, brake_pressed, regen_pressed, standstill, cruise_standstill, v_cruise, v_target, v_target_future, a_target, CP):
    ...
    if self.long_control_state == LongCtrlState.off or gas_pressed or brake_pressed or regen_pressed:
