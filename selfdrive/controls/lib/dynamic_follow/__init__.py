...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      y_dist = [2.5, 2.5, 2.5, 2.5, 2.5, 2.6, 2.7, 2.8, 2.9, 3.0, 3.1]
      ...
      #y_dist = [1.4, 1.41, 1.44, 1.55, 1.75, 1.9, 2.05, 2.2, 2.35, 2.5, 2.52]
      y_dist = [2.2, 2.3, 2.35, 2.4, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5]
    ...
    sng_TR = 2.0  # reacceleration stop and go TR
    sng_speed = 10.0 * CV.KPH_TO_MS
