...
- Some lateral control tuning
   ...
   2) Kp : [0.05,0.12,0.18,0.2,0.23], Ki : [0.005,0.01,0.014,0.016,0.018], Kf : 0.000024
   3) SteerRatio : 16.5, Tire Stiffness : 0.8
      [Not recommend to use Steer Ratio Learner. After you switch the fork with this, please change the value into "LiveParameters" with default]
   4) Adjust Steer torque 
